    ...
    public function show(Request $request, $id)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'dari' => $kontrak->dari,
                'sampai' => $kontrak->sampai,
                'status_kontrak' => (string) $kontrak->status_kontrak,
                'tanggal' => $kontrak->tanggal,
                'nama_karyawan' => $kontrak->nama_karyawan,
                'nama_jabatan' => $kontrak->nama_jabatan,
                'nama_cabang' => $kontrak->nama_cabang,
                'nama_dept' => $kontrak->nama_dept,
